...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Accounts__3214EC278E71B28A");

            entity.HasIndex(e => e.Username, "UQ__Accounts__536C85E48774862F").IsUnique();
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Books__3214EC27F085280E");
        ...
        {
            entity.HasKey(e => e.BookId).HasName("PK__BookImgs__3DE0C22741A7A029");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__BookType__3214EC27805643D5");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Invoices__3214EC279B732233");
        ...
        {
            entity.HasKey(e => new { e.Id, e.BookId }).HasName("PK__InvoiceD__51CAE00517D59F06");
